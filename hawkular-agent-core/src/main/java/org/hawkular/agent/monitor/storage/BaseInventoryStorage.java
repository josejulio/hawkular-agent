...
/**
 * An {@link InventoryStorage} that collects inventory that has been discovered.
 * Use this as a base class for concrete implementations that need collected inventory.
 */
public abstract class BaseInventoryStorage implements InventoryStorage {

    protected static final String HEADER_HAWKULAR_TENANT = "Hawkular-Tenant";
    ...
    private static class InventoryPayloadBuilder<L> {
         ...
         */
        Offline<org.hawkular.inventory.api.model.ResourceType.Blueprint> buildResourceType(
         ...
         */
        Offline<org.hawkular.inventory.api.model.MetricType.Blueprint> buildMetricType(
    ...
    private static final MsgLogger log = AgentLoggers.getLogger(BaseInventoryStorage.class);
    /**
    ...
    protected final AgentCoreEngineConfiguration.StorageAdapterConfiguration config;
    protected final Diagnostics diagnostics;
    // Visible for testing
    final long persistenceRefreshDelay;

    public BaseInventoryStorage(
            String feedId,
    ...
    public void shutdown() {
        log.debugf("Shutting down inventory storage");
    }
    ...
    private void syncInventoryData(InventoryMetric metric, ExtendedInventoryStructure inventoryStructure,
        ...
        try {
            ...
            storeMetric(metricChunks, headers);
    ...
    private Map<String, String> getTenantHeader(String tenantId) {
        ...
        return Collections.singletonMap(HEADER_HAWKULAR_TENANT, tenantId);
    }

    protected abstract void deleteMetric(InventoryMetric metric, Map<String, String> headers);

    protected abstract void storeMetric(InventoryMetric.WithData metric, Map<String, String> headers) throws Exception;

    protected abstract void tagMetric(InventoryMetric.WithData metric, Map<String, String> headers) throws Exception;
